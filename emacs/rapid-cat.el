...
(define-minor-mode rapid-cat-orange
  ...
  (keymap
   ...
   "b" (make-insertion "expenses:tabby")
   "c" (keymap "c" (make-insertion "expenses:car:other")
               "p" (make-insertion "expenses:car:petrol")
   ...
   "u" (keymap "u" (make-insertion "expenses:utilities")
               "w" (make-insertion "expenses:utilities:water")
